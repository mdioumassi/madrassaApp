                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('registrations.adults') }}">{{ _('Inscriptions adultes') }}</a>
                            </li>
                        </ul>
                                        ...
                                        <td>
                                            ...
                                            @if ($registration->child->is_registered($registration->child->id))
                                                <button class="btn btn-info btn-sm" data-bs-toggle="modal"
                                                    ...
                                                    @else
                                                    <a class="w3-button w3-black" href="{{route('step1.register.child.create', $registration->parent->id)}}">{{_('Inscrire')}}</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
