                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a href="{{ route('registrations.children') }}" aria-current="page"
                                    class="nav-link">{{ _('Inscriptions enfants') }}</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <table class="table table-bordered mt-2">
                            <thead>
                                <tr>
                                    <th class="w3-green text-light">Civité</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($registrations as $registration)
                                    <tr>
                                        <td>{{ $registration->adult->civility }}</td>
                                        <td>{{ $registration->adult->name }}</td>
                                        <td>{{ $registration->adult->lastname }}</td>
                                        <td>{{ $registration->adult->email }}</td>
                                        <td>{{ $registration->adult->phone }}</td>
