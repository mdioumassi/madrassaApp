                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="bg-success text-light">{{ _('Classes') }}</th>
                                    <th class="bg-success text-light">{{ _('Mots clés') }}</th>
                                    <th class="bg-success text-light">{{ _('status') }}</th>
                            ...
                            <tbody>
                                @foreach ($courses as $course)
                                    <tr>
                                        ...
                                        <td>{{$course->status}}</td>
                                        <td>
                                            <a href="{{ route('admin.courses.add.levels', $course->id) }}"
                                                class="btn btn-primary">{{ _('Add Levels') }}</a>
